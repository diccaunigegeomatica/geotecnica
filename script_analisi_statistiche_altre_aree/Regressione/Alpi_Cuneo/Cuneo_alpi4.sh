...
r.regression.multi --overwrite mapx="$litologia,$quota,$esposizione,$accumulazione,$distanza_strade,$pendenza,$uso_suolo,$morfologia" mapy="logit_cuneo" residuals="res_8_NO_AC" estimates="est_8_NO_AC" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/Cuneo_alpi/cuneo_8_coeff_regressione_8var.txt"
exit 0