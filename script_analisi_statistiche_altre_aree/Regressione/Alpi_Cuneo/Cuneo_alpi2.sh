...
r.regression.multi --overwrite mapx="$litologia,$AC,$quota,$esposizione,$accumulazione,$distanza_strade,$pendenza,$uso_suolo" mapy="logit_cuneo" residuals="res_8" estimates="est_8" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/Cuneo_alpi/cuneo_8_coeff_regressione_8var.txt"
exit 0