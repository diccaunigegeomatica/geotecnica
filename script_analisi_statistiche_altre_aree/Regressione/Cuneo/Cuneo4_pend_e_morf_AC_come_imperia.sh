...
r.regression.multi --overwrite mapx="$litologia,$quota,$esposizione,$accumulazione,$pendenza,$morfologia,$uso_suolo,$AC,$distanza_strade" mapy="logit_cuneo" residuals="res_9_AC_4classi_come_imperia" estimates="est_9_AC_4classi_come_imperia" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_9var_AC_4classi_come_imperia.txt"
exit 0