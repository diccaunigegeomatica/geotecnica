...
# #5 variabili (+AC)
# r.regression.multi --overwrite mapx="$pendenza,$quota,$litologia,$esposizione" mapy="logit_cuneo" residuals="res_5" estimates="est_5" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_5var.txt"

# #6 variabili (+uso suolo)
# r.regression.multi --overwrite mapx="$pendenza,$quota,$litologia,$esposizione,$uso_suolo" mapy="logit_cuneo" residuals="res_6" estimates="est_6" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_6var.txt"

# #7 variabili (+accumulazione)
# r.regression.multi --overwrite mapx="$pendenza,$quota,$litologia,$esposizione,$uso_suolo,$accumulazione" mapy="logit_cuneo" residuals="res_7" estimates="est_7" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_7var.txt"

#8 variabili (+distanza strade)
r.regression.multi --overwrite mapx="$pendenza,$quota,$litologia,$esposizione,$uso_suolo,$accumulazione,$distanza_strade" mapy="logit_cuneo" residuals="res_8_finale_NO_AC" estimates="est_8_finale_NO_AC" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_NO_AC_coeff_regressione_8var.txt"
exit 0