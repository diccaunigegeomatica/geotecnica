...
pendenza="slope_5classi"
quota="classi_quota_250"
litologia="classi_litologia_come_Imperia"
esposizione="aspect_4classi_B_crescente"
AC="AC_3classi"
uso_suolo="classi_uso_suolo_come_Imperia"
...
r.regression.multi --overwrite mapx="$pendenza,$quota,$litologia,$esposizione,$AC,$uso_suolo,$accumulazione,$distanza_strade" mapy="logit_cuneo" residuals="res_8" estimates="est_8" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_8var.txt"
exit 0