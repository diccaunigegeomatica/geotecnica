...
r.regression.multi --overwrite mapx="$litologia,$quota,$esposizione,$accumulazione,$pendenza,$uso_suolo,$AC,$distanza_strade" mapy="logit_cuneo" residuals="res_8_finale" estimates="est_8_finale" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/cuneo_8_coeff_regressione_8var.txt"
exit 0