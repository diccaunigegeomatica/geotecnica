...
r.regression.multi --overwrite mapx="$accumulazione,$esposizione,$litologia,$quota,$distanza_strade,$uso_suolo,$morfologia" mapy="logit_torino" residuals="res_8_NO_AC" estimates="est_8_NO_AC" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/torino_8_coeff_regressione_NO_AC.txt"
exit 0