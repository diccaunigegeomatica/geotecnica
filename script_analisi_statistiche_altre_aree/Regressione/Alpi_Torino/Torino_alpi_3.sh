...
r.regression.multi --overwrite mapx="$accumulazione,$esposizione,$AC,$litologia,$pendenza,$quota,$distanza_strade,$uso_suolo" mapy="logit_torino" residuals="res_8" estimates="est_8" output="/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Regressione/torino_8_coeff_regressione_8var.txt"
exit 0