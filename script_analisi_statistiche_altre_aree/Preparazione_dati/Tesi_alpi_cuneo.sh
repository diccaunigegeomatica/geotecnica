...
r.in.gdal input=/media/sf_Tesi/Dati/Piemonte/DEM_5m/alpi_cuneo.tif output=dem

v.in.ogr input=/media/sf_Tesi/Dati/Piemonte/Cuneo/Cuneo.shp layer=Cuneo output=Cuneo

v.overlay ainput=spazio_alpino binput=Cuneo operator=and output=alpi_cuneo
...
v.to.rast input=spazio_alpino output=cuneo use=cat
...
#r.stats -c -n input=Area_calibrazione,slope_13classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_slope_13classi.txt separator=comma
...
#r.reclass --overwrite input=classi_litologia output=classi_litologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Piemonte_reclass_litologia_crescente.txt
r.reclass --overwrite input=classi_litologia output=classi_litologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Cuneo_alpi_reclass_litologia_crescente.txt
...
r.reclass --overwrite input=classi_uso_suolo output=classi_uso_suolo_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Cuneo_alpi_reclass_uso_suolo_crescente.txt
...
r.stats --overwrite -c -n input=Area_calibrazione,buf_strade output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_strade.txt separator=comma
#r.stats --overwrite -c -n input=Area_calibrazione,buf_strade_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_strade_crescente.txt separator=comma
...
r.reclass  --overwrite input=aggressivita_climatica output=AC_6classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Cuneo_reclass_AC_6classi.txt
...
r.reclass  --overwrite input=aggressivita_climatica output=AC_2classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Cuneo_alpi_reclass_AC_2classi.txt

r.reclass  --overwrite input=aggressivita_climatica_int output=AC_3classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Piemonte_reclass_AC_3classi.txt



r.stats -c -n input=Area_calibrazione,AC_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_3classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,AC_5classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_5classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,AC_7classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_7classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,AC_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_2classi.txt separator=comma


r.stats -c -n input=Area_calibrazione,classi_uso_suolo output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_uso_suolo.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_uso_suolo_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_uso_suolo_crescente.txt separator=comma


#r.stats -c -n input=Area_calibrazione,AC_6classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_6classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_6classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_6classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_2classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,AC_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_AC_3classi.txt separator=comma

r.stats -c -n --overwrite input=Area_calibrazione,classi_accumulazione output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_accumulazione.txt separator=comma



r.stats -c -n input=Area_calibrazione,aspect_classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_8classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_mapcalc output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_mapcalc.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_2classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_4classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_2classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_2classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_crescente_scaletta output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_crescente_scaletta.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_B output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_B.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_B_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_B_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_C output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_aspect_4classi_C.txt separator=comma



r.stats -c -n input=Area_calibrazione,slope_classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_slope_9classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,slope_5classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_slope_5classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,slope_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_slope_3classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,morfologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_morfologia.txt separator=comma
#r.stats -c -n input=Area_calibrazione,classi_morfologia_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_morfologia_crescente.txt separator=comma



r.stats -c -n input=Area_calibrazione,slope_param_scale_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_slope_param_scale_3classi.txt separator=comma


r.stats -c -n input=Area_calibrazione,classi_quota_250 output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_quota_250.txt separator=comma


r.stats -c -n input=Area_calibrazione,classi_litologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_litologia.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_litologia_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_classi_litologia_crescente.txt separator=comma


#r.stats -c -n input=Area_calibrazione,litologia_reclass output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/Cuneo_alpi/stats_litologia_reclass_28.txt separator=comma
