...
r.in.gdal input=/media/sf_Tesi/Dati/Piemonte/DEM_5m/Torino_20m output=dem
...
regione=Torino #Vettore che delimita l'area di studio
...
r.reclass --overwrite input=aspect_2classi output=aspect_2classi_crescente rules="/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_esposizione_2classi.txt"
...
r.reclass --overwrite input=aspect_4classi output=aspect_4classi_crescente rules="/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_esposizione_4classi.txt"
...
r.mapcalc --overwrite expression="slope_param_scale_7classi=if($dem_iniziale==0,null(),if(slope_param_scale>=0&&slope_param_scale<5,1,if(slope_param_scale>=5&&slope_param_scale<10,2,if(slope_param_scale>=10&&slope_param_scale<15,3,if(slope_param_scale>=15&&slope_param_scale<20,4,if(slope_param_scale>=20&&slope_param_scale<25,5,if(slope_param_scale>=25&&slope_param_scale<30,6,if(slope_param_scale>=30,7))))))))"

r.param.scale input=$dem_iniziale output=morfologia size=9 method=feature

r.reclass --overwrite input=morfologia output=classi_morfologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_morfologia.txt
...
#Per quel che riguarda Torino qui importo i file di litologia, uso suolo e strade già fatti per la Liguria, l'aggressività climatica si usa quella interpolata sui txti Arpal. Per fare altre regioni bisogna implementare lo script con i txti delle stesse.
...
g.copy raster=classi_litologia_Torino@Dati_Piemonte,classi_litologia
...
r.reclass input=classi_litologia output=classi_litologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_litologia_crescente.txt
...
r.reclass --overwrite input=classi_uso_suolo output=classi_uso_suolo_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_uso_suolo_crescente.txt
...
r.reclass input=aggressivita_climatica output=AC_6classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_AC_6classi.txt
r.reclass input=aggressivita_climatica output=AC_2classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_AC_2classi.txt
...
r.reclass input=aggressivita_climatica output=AC_3classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_reclass_AC_3classi.txt
...
r.stats -c -n input=Area_calibrazione,AC_meteoswiss_5classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_meteoswiss_5classi.txt separator=comma
...
r.stats -c -n input=Area_calibrazione,AC_meteoswiss_5classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_meteoswiss_5classi_crescente.txt separator=comma
...
r.stats -c -n input=Area_calibrazione,aspect_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_2classi(b).txt separator=comma
...
r.stats -c -n input=Area_calibrazione,aspect_4classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi_alpi/stats_aspect_4classi_crescente.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_4classi_B output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi_alpi/stats_aspect_4classi_B.txt separator=comma
...
r.stats -c -n input=Area_calibrazione,slope_classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_9classi_crescente.txt separator=comma
...
r.stats -c -n input=Area_calibrazione,classi_uso_suolo output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_classi_uso_suolo.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_uso_suolo_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_classi_uso_suolo_crescente.txt separator=comma
