...
v.in.ogr input=/media/sf_Tesi/Dati/Piemonte/spazio_alpino/spazio_alpino/spazio_alpino.shp layer=spazio_alpino output=spazio_alpino
...
r.in.gdal input=/media/sf_Tesi/Dati/Piemonte/DEM_5m/alpi_torino.tif output=dem

v.in.ogr input=/media/sf_Tesi/Dati/Piemonte/Torino/Torino.shp layer=Torino output=Torino

v.overlay ainput=spazio_alpino binput=Torino operator=and output=alpi_torino


dem_iniziale=dem #raster
frane=frane_considerate #vettore contenente le frane che decido di prendere in esame
regione=spazio_alpino #Vettore che delimita l'area di studio
litologia=litologia_regione #vettore contenente la litologia
g.region raster=dem
#g.region res=20
#g.region -p

#r.mask vector=spazio_alpino
#r.mapcalc --overwrite "torino=dem"
#g.remove -f type=raster name=dem
#r.mask -r

#g.region raster=torino
...
v.overlay ainput=spazio_alpino binput=scivolamenti_pol_sup_full operator=and output=tmp_frane_aree 
v.overlay ainput=lin_full binput=spazio_alpino operator=and output=tmp_frane_lineari 
...
v.to.rast input=spazio_alpino output=torino use=cat
...
g.region res=5
v.overlay ainput=spazio_alpino binput=aree_validaz2_complesse operator=and output=tmp_frane_complesse
...
v.overlay ainput=spazio_alpino binput=aree_validaz3_incipient_slide operator=and output=tmp_frane_incipient_slide
...
v.overlay ainput=spazio_alpino binput=aree_validaz4_indizi_instab operator=and output=tmp_frane_indizi_instab
...
v.overlay ainput=spazio_alpino binput=aree_validaz5_indet operator=and output=tmp_frane_indet
...
v.overlay ainput=spazio_alpino binput=scivolamenti_incipienti operator=and output=tmp_scivolamenti_incipienti
...
#r.stats -c -n input=Area_calibrazione,slope_13classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_13classi.txt separator=comma
...
r.param.scale input=$dem_iniziale output=morfologia size=9 method=feature
r.reclass --overwrite input=morfologia output=classi_morfologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_alpi_reclass_morfologia.txt
...
################################
r.fill.dir --overwrite input=$dem_iniziale output=torino_depressionless direction=torino_flow_direction
r.watershed --overwrite elevation=torino_depressionless threshold=2500 accumulation=accumulazione
...
#r.stats -c -n --overwrite input=Area_calibrazione,classi_accumulazione output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_accumulazione.txt separator=comma
...
r.reclass input=classi_litologia output=classi_litologia_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/torino_alpi_reclass_litologia.txt
...
g.copy raster=classi_uso_suolo_Torino@Dati_Piemonte,classi_uso_suolo
...
r.reclass --overwrite input=classi_uso_suolo output=classi_uso_suolo_crescente rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_alpi_reclass_uso_suolo_crescente.txt

#################################
# strade
################################

g.copy raster=buf_strade_Torino@Dati_Piemonte,buf_strade
r.mask raster=$dem_iniziale
...
#v.overlay ainput=tratte_stradali binput=spazio_alpino operator=and output=strade 
...
r.stats --overwrite -c -n input=Area_calibrazione,buf_strade output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_strade.txt separator=comma
#r.stats --overwrite -c -n input=Area_calibrazione,buf_strade_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_strade_crescente.txt separator=comma
...
r.reclass --overwrite input=aggressivita_climatica output=AC_7classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Piemonte_reclass_AC.txt
r.reclass --overwrite input=aggressivita_climatica output=AC_5classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Piemonte_reclass_AC_5classi.txt
r.reclass --overwrite input=aggressivita_climatica output=AC_3classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Piemonte_reclass_AC_3classi.txt
r.reclass --overwrite input=aggressivita_climatica output=AC_2classi rules=/home/lorenzo/Scrivania/GRASS/calcoli/regole_reclass/Bobbio/Torino_alpi_reclass_AC_2classi.txt


#r.stats -c -n input=Area_calibrazione,AC_5classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_5classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,AC_7classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_7classi.txt separator=comma

r.stats -c -n input=Area_calibrazione,classi_uso_suolo output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_uso_suolo.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_uso_suolo_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_uso_suolo_crescente.txt separator=comma


#r.stats -c -n input=Area_calibrazione,AC_6classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_6classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_6classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_6classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_2classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,AC_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_AC_3classi.txt separator=comma


r.stats -c -n input=Area_calibrazione,aspect_classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_8classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_mapcalc output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_mapcalc.txt separator=comma
r.stats -c -n input=Area_calibrazione,aspect_2classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_2classi.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_2classi_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_2classi_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_crescente_scaletta output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_crescente_scaletta.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_B output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_B.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_B_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_B_crescente.txt separator=comma
#r.stats -c -n input=Area_calibrazione,aspect_4classi_C output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_aspect_4classi_C.txt separator=comma



r.stats -c -n input=Area_calibrazione,slope_classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_9classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,slope_5classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_5classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,slope_param_scale_4classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_param_scale_4classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,slope_param_scale_classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_param_scale_9classi.txt separator=comma

#r.stats -c -n input=Area_calibrazione,slope_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_3classi.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_morfologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_morfologia.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_morfologia_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_morfologia_crescente.txt separator=comma



#r.stats -c -n input=Area_calibrazione,slope_param_scale_3classi output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_slope_param_scale_3classi.txt separator=comma


r.stats -c -n input=Area_calibrazione,classi_quota_250 output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_quota_250.txt separator=comma


r.stats -c -n input=Area_calibrazione,classi_litologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_litologia.txt separator=comma
r.stats -c -n input=Area_calibrazione,classi_litologia_crescente output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_classi_litologia_crescente.txt separator=comma


#r.stats -c -n input=Area_calibrazione,litologia_reclass output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_litologia_reclass_28.txt separator=comma

r.stats -c -n input=Area_calibrazione,morfologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_morfologia.txt separator=comma
r.stats -c -n input=Area_calibrazione,morfologia output=/media/sf_Tesi/Lorenzo/Script_Lorenzo/Piemonte/Analisi_univariata/torino_alpi/stats_morfologia.txt separator=comma
